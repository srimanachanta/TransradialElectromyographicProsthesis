...
if __name__ == "__main__":
    ...
    generate_and_save_y_data("data/index_duo", y_name, **get_dataset_meta("data/index_duo", "muscle_data.npy", video_len_seconds=10.833), joint_actions=[
        ...
        [(1.067, 1), (1.367, 0), (1.900, 2), (2.300, 0), (3.667, 1), (3.767, 0), (3.800, 2), (4.067, 0), (4.967, 1), (5.200, 0), (5.267, 2), (5.367, 0), (6.668, 1), (6.868, 0),
         (7.902, 2), (8.502, 0)],
    ...
    generate_and_save_y_data("data/thumb_duo_press", y_name, **get_dataset_meta("data/thumb_duo_press", "muscle_data.npy", video_len_seconds=8.768), joint_actions=[
        [(6.002, 1), (6.068, 0)],
        [(1.367, 1), (1.667, 0), (1.833, 2), (1.967, 0), (2.933, 1), (3.267, 0), (3.467, 2), (3.667, 0), (4.500, 1), (4.800, 0), (4.867, 2), (5.167, 0), (6.035, 1), (6.202, 0),
         (6.302, 2), (6.702, 0)],
    ...
    generate_and_save_y_data("data/index_duo_press", y_name, **get_dataset_meta("data/index_duo_press", "muscle_data.npy", video_len_seconds=8.7), joint_actions=[
        ...
        [],
        [(1.067, 1), (1.333, 0), (1.433, 2), (1.567, 0), (2.333, 1), (2.500, 0), (2.667, 2), (2.833, 0), (3.600, 1), (4.033, 0), (4.200, 2), (4.333, 0), (5.533, 1), (6.368, 0),
         (6.368, 2), (6.535, 0)],
        [],
    ...
    generate_and_save_y_data("data/middle_duo_press", y_name, **get_dataset_meta("data/middle_duo_press", "muscle_data.npy", video_len_seconds=8.202), joint_actions=[
        ...
        [],
        [(0.833, 1), (1.200, 0), (1.400, 2), (1.533, 0), (2.367, 1), (2.700, 0), (2.767, 2), (2.900, 0), (3.800, 1), (4.133, 0), (4.167, 2), (4.367, 0), (5.533, 1), (6.002, 0),
         (6.535, 2), (6.735, 0)],
        [],
    ...
    generate_and_save_y_data("data/ring_duo_press", y_name, **get_dataset_meta("data/ring_duo_press", "muscle_data.npy", video_len_seconds=8.133), joint_actions=[
        ...
        [],
        [(1.033, 1), (1.300, 0), (1.467, 0), (1.667, 0), (2.933, 1), (3.233, 0), (3.400, 2), (3.600, 0), (4.533, 1), (4.733, 0), (4.933, 2), (5.133, 0), (5.935, 1), (6.235, 0),
         (6.302, 2), (6.535, 0)],
        [],
    ...
    generate_and_save_y_data("data/pinkie_duo_press", y_name, **get_dataset_meta("data/pinkie_duo_press", "muscle_data.npy", video_len_seconds=8.767), joint_actions=[
        ...
        [],
        [(1.200, 1), (1.633, 0), (1.667, 2), (1.900, 0), (2.9, 1), (3.133, 0), (3.267, 2), (3.500, 0), (4.80, 1), (5.067, 0), (5.668, 2), (5.835, 0), (6.502, 1), (7.235, 0),
         (7.468, 2), (7.702, 2)],
        []])
    generate_and_save_y_data("data/wrist", y_name, **get_dataset_meta("data/wrist", "muscle_data.npy", video_len_seconds=15.435), joint_actions=[
        ...
        [],
        [],
        [(0.367, 2), (0.867, 0), (1.0, 1), (1.8, 0), (2.267, 1), (2.7, 0), (2.867, 2), (3.567, 0), (7.102, 2), (7.735, 0), (7.835, 1), (8.302, 0), (8.768, 1), (9.235, 0),
         (9.435, 2), (9.902, 0)]])
    generate_and_save_y_data("data/fist", y_name, **get_dataset_meta("data/fist", "muscle_data.npy", video_len_seconds=11.167), joint_actions=[
        [(0.767, 2), (1.0, 0), (1.7, 1), (2.0, 0), (2.433, 2), (2.7, 0), (3.533, 1), (3.9, 0), (4.267, 1), (4.633, 0), (5.4, 1), (5.768, 0), (6.068, 2), (6.402, 0), (7.168, 1),
         (7.602, 0), (7.835, 2), (8.168, 0)],
        [(0.633, 2), (1.133, 0), (1.533, 1), (2.167, 0), (2.367, 2), (2.933, 0), (3.367, 1), (4.1, 0), (4.167, 1), (4.8, 0), (5.267, 1), (5.935, 0), (6.035, 2), (6.635, 0),
         (7.002, 1), (7.635, 0), (7.735, 2), (8.468, 0)],
        [(0.767, 2), (1.0, 0), (1.7, 1), (2.0, 0), (2.433, 2), (2.7, 0), (3.533, 1), (3.9, 0), (4.267, 1), (4.633, 0), (5.4, 1), (5.768, 0), (6.068, 2), (6.402, 0), (7.168, 1),
         (7.602, 0), (7.835, 2), (8.168, 0)],
        [(0.633, 2), (1.133, 0), (1.533, 1), (2.167, 0), (2.367, 2), (2.933, 0), (3.367, 1), (4.1, 0), (4.167, 1), (4.8, 0), (5.267, 1), (5.935, 0), (6.035, 2), (6.635, 0),
         (7.002, 1), (7.635, 0), (7.735, 2), (8.468, 0)],
        ...
        [(0.633, 2), (1.133, 0), (1.533, 1), (2.167, 0), (2.367, 2), (2.933, 0), (3.367, 1), (4.1, 0), (4.167, 1), (4.8, 0), (5.267, 1), (5.935, 0), (6.035, 2), (6.635, 0),
         (7.002, 1), (7.635, 0), (7.735, 2), (8.468, 0)],
        [(0.867, 2), (1.0, 0), (1.7, 1), (2.0, 0), (2.433, 2), (2.7, 0), (3.533, 1), (3.9, 0), (4.267, 1), (4.633, 0), (5.4, 1), (5.768, 0), (6.068, 2), (6.402, 0), (7.168, 1),
         (7.602, 0), (7.835, 2), (8.168, 0)],
        [(0.633, 2), (1.133, 0), (1.533, 1), (2.167, 0), (2.367, 2), (2.933, 0), (3.367, 1), (4.1, 0), (4.167, 1), (4.8, 0), (5.267, 1), (5.935, 0), (6.035, 2), (6.635, 0),
         (7.002, 1), (7.635, 0), (7.735, 2), (8.468, 0)],
        []])
    ...
    generate_and_save_y_data("data/piano", y_name, **get_dataset_meta("data/piano", "muscle_data.npy", video_len_seconds=28.97), joint_actions=[
        ...
        [],
        [(6.135, 2), (6.368, 0), (6.635, 2), (6.968, 0), (7.202, 2), (7.502, 0), (7.768, 2), (8.068, 0), (11.635, 2), (11.935, 0), (12.202, 2), (12.435, 0), (12.802, 2),
         (13.602, 0), (16.168, 2), (16.468, 0), (16.702, 2), (16.968, 0), (17.237, 2), (18.070, 0), (23.670, 2), (23.970, 0), (24.203, 2), (24.503, 0), (24.770, 2), (24.970, 0),
         (25.303, 2), (25.637, 0)],
        [],
        [(5.033, 2), (5.233, 0), (5.533, 2), (5.968, 0), (10.502, 2), (10.868, 0), (11.102, 2), (11.435, 0), (15.102, 2), (15.369, 0), (15.635, 2), (15.868, 0), (22.670, 2),
         (22.937, 0), (23.137, 2), (23.537, 0)],
        [],
        [(1.733, 2), (2.067, 0), (2.267, 2), (2.667, 0), (3.9, 2), (4.933, 0), (9.502, 2), (9.735, 0), (10.035, 2), (10.335, 0), (14.305, 2), (14.268, 0), (14.568, 2), (14.802, 0),
         (19.370, 2), (19.570, 0), (19.870, 2), (20.237, 0), (21.503, 2), (22.503, 0)],
        [],
